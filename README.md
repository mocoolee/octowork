...
AI 會讀完你所有的檔案，然後根據現有內容找出可以補強的地方，一次問你一個問題：

- 做事原則太少的工作類型 → 追問你更多判斷依據
- 協作者只有名字沒有風格 → 問你他的溝通眉角
- 做事原則提到某件工作但沒有 Skill → 問你要不要建一個
- 幾個 Skill 常一起用 → 建議串成 Workflow
- company.md 或 products.md 有缺漏 → 幫你補上

你回答後 AI 直接更新對應的檔案。說「夠了」就結束，AI 會摘要這次復盤更新了什麼。
